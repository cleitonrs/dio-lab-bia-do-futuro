...
| `perfil_investidor.json` | JSON | Personalizar as explicações para o cliente |
...
HISTORICO DE ATENDIMENTO OD CLIENTE:
...
O exemplo abaixo mostra as informações mais relevantes.
